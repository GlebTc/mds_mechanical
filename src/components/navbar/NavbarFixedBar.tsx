      ...
      <a
        ...
        onClick={() =>
          sendGAEvent(
            ...
            'click',
            'main_navbar_emergency_call_button'
          )
        }

        //  Parameters:
        // "emergency": This might represent the event category or type.
        // "click": This is likely the event action, indicating what type of interaction occurred.
        // "emergency-contact": This could be a label or additional descriptor for the event.
      >
        <p>
