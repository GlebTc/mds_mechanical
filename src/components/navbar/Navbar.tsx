...
const Navbar = () => {
  return (
    ...
    >
      ...
      <div
        className={`NAVBAR_LOGO_AND_MENU_CONTAINER  bg-gray-400 h-full w-full flex justify-center md:justify-around items-center px-2 pt-[var(--emerg-bar-h-mobile)] md:pt-[var(--emerg-bar-h-desktop)] z-[40] text-[15px] lg:text-[18px]`}
      >
        <div className={`NAVBAR_LOGO_CONTAINER w-[180px] md:w-[100px] lg:w-[200px]`}>
          <a
            href="/"
